...
//localStorage.setItem("rankingUsers",rankingUsers);
//rankingUsers = localStorage.getItem("rankingUsers");
...
document.getElementById("startGame").onclick = function() {nameUser(),showQuestions(), timer() };
...
function sortScore() {
    rankingUsers.push({name: user, score: correct});
    rankingUsers.sort(function (a, b){return (b.score - a.score)});
    rankingUsers.forEach(function(obj){
        
        document.getElementById("playagain").innerHTML = (rankingUsers.indexOf(obj)+1) + "º "+obj.name + " => "+ obj.score + " points";
